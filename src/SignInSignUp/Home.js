...
function Home(){
    ...
    return(
        <div>
            ...
            <form id="myForm" action="puzzle.html">
                <h3>Verify your email address</h3>
                <p>You've have entered {localStorage.getItem('email')} as the email address for your account,</p>
                <p>Please validate your details by clicking button below</p>
                <form id="forms" action="emailjs.html">
                    <button href="emailjs.html" className="Validate">Validate your Email address </button>
                </form>
                    <button href="puzzle.html" className="saveButton" placeholder="Click to Play" >Click to Play</button>
            </form>
